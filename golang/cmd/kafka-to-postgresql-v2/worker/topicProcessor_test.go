...
func TestRecreateTopic(t *testing.T) {
	valid := []string{
		...
		"umh.v1.Che_rnobyl.Auxiliary.Building2.WaterSupply.MainValve1.ValveID-1234._analytics",
		"umh.v1.Che_rnobyl.Auxiliary.Building2.WaterSupply.MainValve1.ValveID-1234._historian",
	}
	invalid := []string{
	...
	for _, validTopic := range valid {
		...
		splitIndex := rand.Intn(len(parts)-1) + 1 //nolint:gosec
