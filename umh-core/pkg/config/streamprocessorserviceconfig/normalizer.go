...
// Normalizer handles the normalization of Stream Processor configurations
type Normalizer struct{}

// NewNormalizer creates a new configuration normalizer for Stream Processor
func NewNormalizer() *Normalizer {
	return &Normalizer{}
}

// NormalizeConfig applies Stream Processor defaults to a structured config
func (n *Normalizer) NormalizeConfig(cfg ConfigSpec) ConfigSpec {
	...
	normalized.Config.DFCConfig = dfcNormalizer.NormalizeConfig(normalized.GetDFCConfig())
