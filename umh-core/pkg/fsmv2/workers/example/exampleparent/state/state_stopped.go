...
func (s *StoppedState) Next(snapAny any) fsmv2.NextResult[any, any] {
	...
	if snap.Desired.ShouldBeRunning() {
		...
		if elapsed >= StoppedWaitDuration {
			return fsmv2.Result[any, any](&TryingToStartState{}, fsmv2.SignalNone, nil, "Wait duration elapsed, transitioning to TryingToStart", nil)
		}
	}

	return fsmv2.Result[any, any](s, fsmv2.SignalNone, nil, "Parent is stopped, no children spawned", nil)
}
