...
func (o *CommunicatorObservedState) SetInboundQueueSize(size int) {
	o.inboundQueueSize = size
}

func (o *CommunicatorObservedState) GetInboundQueueSize() int {
	return o.inboundQueueSize
}

func (o *CommunicatorObservedState) SetOutboundQueueSize(size int) {
	o.outboundQueueSize = size
}

func (o *CommunicatorObservedState) GetOutboundQueueSize() int {
