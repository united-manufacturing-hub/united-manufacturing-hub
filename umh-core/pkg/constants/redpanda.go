...
const (
	...
	RedpandaExpectedMaxP95ExecutionTimePerInstance = RedpandaUpdateObservedStateTimeout + time.Millisecond*65 // needs to be higher than S6ExpectedMaxP95ExecutionTimePerInstance
)
