...
func NewDefaultService() s6.Service {
...
func (s *DefaultService) ExecuteS6Command(ctx context.Context, servicePath string, fsService filesystem.Service, name string, args ...string) (string, error) {
	...
	defer func() {
		...
		metrics.RecordS6CommandExecutionTime(servicePath, name, argsString, duration)
	}()
	...
	if err != nil {
		...
		// Check if error is a context deadline exceeded or cancellation
		switch {
