...
func (s *TryingToStartState) Next(snapAny any) fsmv2.NextResult[any, any] {
	...
	if snap.Observed.ID == "" {
		return fsmv2.Result[any, any](s, fsmv2.SignalNone, &action.StartAction{}, "ID not set, executing StartAction", nil)
	}
	...
	if snap.Observed.ChildrenHealthy > 0 && snap.Observed.ChildrenUnhealthy == 0 {
		return fsmv2.Result[any, any](&RunningState{}, fsmv2.SignalNone, nil, "All children healthy, transitioning to Running", nil)
	}

	return fsmv2.Result[any, any](s, fsmv2.SignalNone, nil, "Waiting for all children to become healthy", nil)
}
