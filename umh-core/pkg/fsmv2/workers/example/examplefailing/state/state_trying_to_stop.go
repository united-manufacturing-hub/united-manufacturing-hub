...
func (s *TryingToStopState) Next(snapAny any) fsmv2.NextResult[any, any] {
	...
	if snap.Observed.ConnectionHealth == "no connection" {
		return fsmv2.Result[any, any](&StoppedState{}, fsmv2.SignalNone, nil, "disconnected successfully", nil)
	}

	return fsmv2.Result[any, any](s, fsmv2.SignalNone, &action.DisconnectAction{}, "attempting to disconnect cleanly", nil)
}
