...
var (
	goodDataflowComponentConfig = dataflowcomponentserviceconfig.DataflowComponentServiceConfig{
...
func CreateProtocolConverterTestConfig(name string, desiredState string) config.ProtocolConverterConfig {
	return config.ProtocolConverterConfig{
		...
		ProtocolConverterServiceConfig: protocolconverterserviceconfig.ProtocolConverterServiceConfig{
			DataflowComponentServiceConfig: goodDataflowComponentConfig,
