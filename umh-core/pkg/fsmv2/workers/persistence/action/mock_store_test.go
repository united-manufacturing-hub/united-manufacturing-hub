...
type mockTriangularStore struct {
	compactDeltasCalled    bool
	compactDeltasRetention time.Duration
...
func (m *mockTriangularStore) CompactDeltas(_ context.Context, retentionWindow time.Duration) (int, error) {
	m.compactDeltasCalled = true
	m.compactDeltasRetention = retentionWindow
