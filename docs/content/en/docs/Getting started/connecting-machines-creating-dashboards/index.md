...
Now the dashboard should look like this. In the upper right corner you can set the time span in which the data should be displayed and how often the dashboard should be refreshed. The complete Node-RED flow can be downloaded [here](/examples/node_red_flow_final.json)
