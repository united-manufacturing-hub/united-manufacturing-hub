...
type RedpandaFailure interface {
	...
	IsFailure(log process_shared.LogEntry, transitionToRunningTime time.Time) bool
}
...
func (a *AddressAlreadyInUseFailure) IsFailure(log process_shared.LogEntry, _ time.Time) bool {
...
func (r *ReactorStalledFailure) IsFailure(log process_shared.LogEntry, transitionToRunningTime time.Time) bool {
