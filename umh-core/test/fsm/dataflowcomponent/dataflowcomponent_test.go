...
var _ = Describe("DataFlowComponent FSM", func() {
	...
	Context("Error Handling", func() {
		It("should handle S6 service not exist error correctly", func() {
			...
			mockService.StatusError = fmt.Errorf("failed to get benthos config: failed to get benthos config file for service benthos-dataflow-%s: %w", componentName, s6_shared.ErrServiceNotExist)
