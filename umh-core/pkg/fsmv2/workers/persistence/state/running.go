...
func (s *RunningState) Next(snapAny any) fsmv2.NextResult[any, any] {
	...
	if snap.Desired.IsShutdownRequested() {
		return fsmv2.Result[any, any](&ShuttingDownState{}, fsmv2.SignalNone, nil, "Shutdown requested", nil)
	}

	if !snap.Observed.IsHealthy() {
		return fsmv2.Result[any, any](&RunningDegradedState{}, fsmv2.SignalNone, nil, "Action failed, entering degraded state", nil)
	}
