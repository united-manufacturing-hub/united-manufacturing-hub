...
4. Enterprise accounts then enter their passphrase, which unlocks their access to the instances. For Community accounts with a password, the password already did this. See [Why every sign-in asks for the passphrase](passwords-and-passphrases.md#why-every-sign-in-asks-for-the-passphrase).
