...
func (s *DegradedState) Next(snapAny any) fsmv2.NextResult[any, any] {
	...
	if snap.Observed.HasTransport && snap.Observed.HasValidToken {
		return fsmv2.Result[any, any](s, fsmv2.SignalNone, &action.PushAction{}, "Degraded, still pushing")
	}

	return fsmv2.Result[any, any](s, fsmv2.SignalNone, nil, "Degraded, waiting for transport or token")
}
