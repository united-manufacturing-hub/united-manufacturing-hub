...
const (
	...
	StreamProcessorExpectedMaxP95ExecutionTimePerInstance = time.Millisecond * 50 // needs to be higher than DataflowComponentExpectedMaxP95ExecutionTimePerInstance
)

const (
	// Used to set the context timeout for updating the observed state of a ProtocolConverter instance.
	StreamProcessorUpdateObservedStateTimeout = time.Millisecond * 5
)
