...
Connect with the edge device and the Kubernetes credentials in your clipboard [^Lens-connect]. Ensure that you have adjusted the IP in the Kubernetes credentials with the IP of the edge device.

TODO: image of the line that needs to be changed

You have now acceess to the Kubernetes cluster!

[^Lens-connect]: LINK TO TECHNIQUES
