...
Magic Link lets you sign in without a password. You enter your email address. Our identity provider emails you a one-time code. You type that code into the sign-in screen. Other pages in this documentation call this method a one-time code sent to your email address. The sign-in screens call it **Magic Link**.

## Who this applies to

Magic Link is the default for Community accounts.
...
Some older Community accounts still use a username and password. When you enter such an email address, the console sends you to that older login instead. Magic Link becomes available once we have moved your account across. See [Username and Password](username-and-password.md).
...
4. Enter your passphrase. Signing in proves who you are; the passphrase decrypts your certificate, and Magic Link does not replace it. See [Passwords and Passphrases](passwords-and-passphrases.md#why-every-sign-in-still-asks-for-it).
...
## Why we use Magic Links as our default
...
- **Your passphrase stays yours.** Magic Link proves who you are; the passphrase separately decrypts your certificate and never leaves your device. See [Passwords and Passphrases](passwords-and-passphrases.md).
