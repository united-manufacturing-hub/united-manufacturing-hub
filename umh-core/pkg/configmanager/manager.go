...
func (m *FileConfigManagerWithBackoff) GetConfigWithOverwritesOrCreateNew(ctx context.Context, configOverride config.FullConfig) (config.FullConfig, error) {
	return m.configManager.GetConfigWithOverwritesOrCreateNew(ctx, configOverride)
}
