...
const (
	...
	RedpandaExpectedMaxP95ExecutionTimePerInstance = RedpandaUpdateObservedStateTimeout + time.Millisecond*35 + time.Millisecond*40 // needs to be higher than S6ExpectedMaxP95ExecutionTimePerInstance
)
