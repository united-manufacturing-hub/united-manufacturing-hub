...
func WaitForBenthosManagerInstanceState(
	...
	for range maxAttempts {
		...
		snapshot.SnapshotTime = baseTime.Add(time.Duration(tick) * constants.DefaultTickerTime) //nolint:gosec // G115: Safe conversion, test tick count is reasonable duration
		snapshot.Tick = tick
