...
func TestAddLowSpeedStates_1(t *testing.T) {
	...
	err := internal.Load("../../test/testfiles/addLowSpeedStates_stateArray_1601391491.golden", &stateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_configuration_1601391491.golden", &configuration)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_countSlice_1601391491.golden", &countSlice)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_processedStateArray_1601391491.golden", &processedStateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
...
func TestAddLowSpeedStates_2(t *testing.T) { // Complex
	...
	err := internal.Load("../../test/testfiles/addLowSpeedStates_stateArray_1601392511.golden", &stateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_configuration_1601392511.golden", &configuration)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_countSlice_1601392511.golden", &countSlice)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_processedStateArray_1601392511.golden", &processedStateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
...
func TestAddLowSpeedStates_NoLowSpeed_1(t *testing.T) {
	...
	err := internal.Load("../../test/testfiles/addLowSpeedStates_stateArray_1601392325.golden", &stateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_configuration_1601392325.golden", &configuration)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_countSlice_1601392325.golden", &countSlice)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addLowSpeedStates_processedStateArray_1601392325.golden", &processedStateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
...
func TestAddUnknownMicrostops_OnlyMicrostops(t *testing.T) {
	...
	err := internal.Load("../../test/testfiles/addUnknownMicrostops_stateArray_1601323210.golden", &stateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addUnknownMicrostops_configuration_1601323210.golden", &configuration)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addUnknownMicrostops_processedStateArray_1601323210.golden", &processedStateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
...
func TestAddUnknownMicrostops_OnlyMicrostopsOneStop(t *testing.T) {
	...
	err := internal.Load("../../test/testfiles/addUnknownMicrostops_stateArray_1601323241.golden", &stateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addUnknownMicrostops_configuration_1601323241.golden", &configuration)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/addUnknownMicrostops_processedStateArray_1601323241.golden", &processedStateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
...
func TestProcessStates_Complex_1(t *testing.T) {
	...
	err := internal.Load("../../test/testfiles/processStates_stateArray_1601585625.golden", &stateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/processStates_rawShifts_1601585625.golden", &rawShifts)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/processStates_countSlice_1601585625.golden", &countSlice)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/processStates_configuration_1601585625.golden", &configuration)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/processStates_from_1601585625.golden", &from)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
	err = internal.Load("../../test/testfiles/processStates_to_1601585625.golden", &to)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}

	err = internal.Load("../../test/testfiles/processStates_processedStateArray_1601585625.golden", &processedStateArray)
	if err != nil {
		fmt.Println(err)
		t.Error()
	}
