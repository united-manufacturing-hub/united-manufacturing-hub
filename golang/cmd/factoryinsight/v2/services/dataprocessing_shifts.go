...
func IsTimerangeEntirelyInTimerange(firstTimeRange, secondTimeRange TimeRange) bool {
...
func IsStateEntirelyInNoShift(state, followingState datamodel.StateEntry, processedShifts []datamodel.ShiftEntry) bool {
...
func GetOverlappingShifts(state, followingState datamodel.StateEntry, processedShifts []datamodel.ShiftEntry) (overlappingShifts []datamodel.ShiftEntry) {
	firstTimeRange := TimeRange{state.Timestamp, followingState.Timestamp}
...
func IsStateEntirelyOutsideNoShift(state, followingState datamodel.StateEntry, processedShifts []datamodel.ShiftEntry) bool {
	firstTimeRange := TimeRange{state.Timestamp, followingState.Timestamp}
...
func RecursiveSplittingOfShiftsToAddNoShifts(dataPoint, followingDataPoint datamodel.StateEntry, processedShifts []datamodel.ShiftEntry, processedStateArrayRaw []datamodel.StateEntry, executionAmount int) (processedStateArray []datamodel.StateEntry) {
	var state int
...
func AddNoShiftsToStates(rawShifts []datamodel.ShiftEntry, stateArray []datamodel.StateEntry, to time.Time) (processedStateArray []datamodel.StateEntry) {
