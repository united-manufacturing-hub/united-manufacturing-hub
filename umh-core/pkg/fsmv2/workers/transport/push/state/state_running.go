...
func (s *RunningState) Next(snapAny any) fsmv2.NextResult[any, any] {
	...
	if snap.Observed.IsStopRequired() {
		return fsmv2.Result[any, any](&StoppingState{}, fsmv2.SignalNone, nil, "Stop required")
	}

	if snap.Observed.ConsecutiveErrors >= 3 {
		return fsmv2.Result[any, any](&DegradedState{}, fsmv2.SignalNone, nil, "Consecutive errors >= 3, degrading")
	}

	if snap.Observed.HasTransport && snap.Observed.HasValidToken {
		return fsmv2.Result[any, any](s, fsmv2.SignalNone, &action.PushAction{}, "Pushing messages")
	}

	return fsmv2.Result[any, any](s, fsmv2.SignalNone, nil, "Waiting for transport or token")
}
