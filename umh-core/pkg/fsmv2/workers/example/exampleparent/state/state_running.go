...
func (s *RunningState) Next(snapAny any) fsmv2.NextResult[any, any] {
	...
	if snap.ChildrenUnhealthy > 0 {
		return fsmv2.Transition(&DegradedState{}, fsmv2.SignalNone, nil, "Some children are unhealthy, transitioning to Degraded", childrenAlive(snap.Config))
	}
	...
	return fsmv2.Transition(s, fsmv2.SignalNone, nil, "All children healthy and running", childrenAlive(snap.Config))
}
