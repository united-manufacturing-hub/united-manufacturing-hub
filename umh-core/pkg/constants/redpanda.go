...
const (
	RedpandaUpdateObservedStateTimeout = 10 * time.Millisecond
)
...
const (
	...
	RedpandaExpectedMaxP95ExecutionTimePerInstance = time.Millisecond * 40 // needs to be higher than S6ExpectedMaxP95ExecutionTimePerInstance
)
