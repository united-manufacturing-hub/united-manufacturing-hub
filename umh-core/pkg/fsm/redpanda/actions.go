...
//
//nolint:maintidx // Core state synchronization function requires complex logic for handling Redpanda service state, configuration, and health monitoring across multiple components
