...
MFA should not be confused with passphrases, which serve a distinct purpose: unlocking your access to your instances. For how sign-in and the passphrase work together, see [Why every sign-in asks for the passphrase](passwords-and-passphrases.md#why-every-sign-in-asks-for-the-passphrase).