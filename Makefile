...
CTR_TAG=latest
## Container image
CTR_IMG=barcodereader factoryinput factoryinsight grafana-proxy grafana-umh hivemq-init kafka-bridge kafka-debug kafka-init kafka-state-detector kafka-to-postgresql metrics mqtt-bridge mqtt-kafka-bridge sensorconnect databridge
