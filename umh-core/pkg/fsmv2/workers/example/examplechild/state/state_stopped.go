...
func (s *StoppedState) Next(snapAny any) fsmv2.NextResult[any, any] {
	...
	if snap.IsStopRequired() {
		return fsmv2.Result[any, any](s, fsmv2.SignalNeedsRemoval, nil, fmt.Sprintf("stop required: shutdown=%t, parentState=%s", snap.IsShutdownRequested, snap.ParentMappedState))
	}
